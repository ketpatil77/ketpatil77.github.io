  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ height: Math.max(360, cardHeight + 120) }}
        tabIndex={0}
        onKeyDown={onKeyDown}
      >
        {/* background wash / spotlight (unique feel) */}
        <div
          className="pointer-events-none absolute inset-x-0 top-6 mx-auto h-48 w-[70%] rounded-full bg-black/5 dark:bg-white/5"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-40 w-[76%] rounded-full bg-black/10 dark:bg-black/30"
          aria-hidden="true"
        />
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
            ...
            {items.map((it, idx) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "focus-ring inline-flex h-11 w-11 items-center justify-center rounded-full transition",
                    on ? "bg-foreground/12" : "hover:bg-foreground/10",
                  )}
                ...
                >
                  <span
                    className={cn(
                      ...
                      on ? "h-2.5 w-2.5 bg-foreground" : "h-2 w-2 bg-foreground/50",
                    )}
                  />
                </button>
              );
          ...
          {activeItem.href ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="focus-ring inline-flex h-11 w-11 items-center justify-center rounded-full text-muted-foreground transition hover:bg-foreground/10 hover:text-foreground"
